...
![alt text](img/AD.png "Average Distance") ![alt text](img/AP.png "Average Precision")
![alt text](img/AP50.png "Average Distance with IoU >= 0.50") ![alt text](img/AP75.png "Average Precision with IoU >= 0.75")
